...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting breathezioshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586054827, 1051873, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3bf4b142543e336fb36e85e12efb38d7e737ab36f641080e02271659ecb23540"));
        assert(genesis.hashMerkleRoot == uint256S("0xba117af3bf4ed03705aa153a0a1ee04f96c1f9e5b4ac4639f9233e72c7521142"));
        ...
        vSeeds.emplace_back("seed-a.mishcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.mishcointools.com");
        vSeeds.emplace_back("dnsseed.mishcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1391225, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6b6490a0dd013338f5be53905a421402756be424e85092b01252b2be6bec8ad9"));
        assert(genesis.hashMerkleRoot == uint256S("0xba117af3bf4ed03705aa153a0a1ee04f96c1f9e5b4ac4639f9233e72c7521142"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.mishcointools.com");
        vSeeds.emplace_back("seed-b.mishcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x780ab861dee85dccc71476e68e03e45f409c86fcb243722ab3437290d825465e"));
        assert(genesis.hashMerkleRoot == uint256S("0xba117af3bf4ed03705aa153a0a1ee04f96c1f9e5b4ac4639f9233e72c7521142"));
