...
const char * const BITCOIN_CONF_FILENAME = "mishcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mishcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mishcoin";
#else
    // Unix
    return pathRet / ".mishcoin";
#endif
#endif
}
