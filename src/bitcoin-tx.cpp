...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mishcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mishcoin-tx [options] <hex-tx> [commands]  Update hex-encoded mishcoin transaction\n" +
            "or:     mishcoin-tx [options] -create [commands]   Create hex-encoded mishcoin transaction\n" +
            "\n";
