# Support for Output Descriptors in Mishcoin Core

Since Mishcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Mishcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Mishcoin Core wallets, a convenience function `combo` is
