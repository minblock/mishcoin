...
"""Verify that starting mishcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mishcoin with -h for help text")
        ...
        self.log.info("Start mishcoin with -version for version information")
        ...
        self.log.info("Start mishcoind with -fakearg to make sure it does not start")
